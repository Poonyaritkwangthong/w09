            ...
            <div class="row">
                ...
                <?php
                    if(isset($_GET['submit'])){
                        ...
                        mysqli_close($conn);
                        echo "เพิ่มคำนำหน้า $prg_name เรียบร้อยแล้ว<br>";
                        echo '<a href="program_list.php">แสดงคำนำหน้าชื่อทั้งหมด</a>';
                    }else{
                ?>
                    <form class="form-horizontal" role="form" name="program_add" action="<?php echo $_SERVER['PHP_SELF']?>">
                        <div class="form-group">
                            <label for="prg_name" class="col-md-2 col-lg-2 control-label">ชื่อข้อมูลสาขา</label>
